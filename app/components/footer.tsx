...
const marqueeItems = ["AMAZING DESIGN", "MEDIA SOLUTIONS", "BRAND GROWTH", "FOCUSED MEDIA"]
...
export function Footer() {
  ...
  return (
    <footer className="bg-linear-to-b from-[#9d8ce0] to-[#030303]">
      <div ref={marqueeRef} className="overflow-hidden border-b border-white/10 py-4">
      ...
      <div className="max-w-6xl mx-auto px-6 py-12 flex flex-col md:flex-row items-start md:items-center justify-between gap-6 border-b border-white/10">
        ...
        <Link
          href="/contact"
          className="px-6 py-2.5 rounded-full border border-emerald-400 text-emerald-400 text-sm font-medium hover:bg-emerald-400 hover:text-[#030303] transition-all duration-300"
        >
          Get In Touch
        </Link>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="flex flex-col gap-4">
            <Link href="/" className="text-2xl font-bold text-white tracking-tight">
              DIGI<span className="text-emerald-400">DAW</span>
            </Link>
          </div>

          {/* Pages */}
          <div>
            <h4 className="text-white font-medium mb-4 text-sm tracking-wide border-b border-white/20 pb-2">Pages</h4>
